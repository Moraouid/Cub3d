...
SRCS = src/cub3d.c src/start_game.c src/parsing/init_var.c src/parsing/parse_colors.c \
		src/parsing/parse_map.c src/parsing/utils.c src/parsing/validate_map.c \
		src/helper/ft_split.c src/helper/ft_strdup.c src/helper/ft_strlen.c src/helper/ft_substr.c \
		src/helper/gc.c src/render/minimap.c src/render/my_mlx_pixel_put.c src/render/window.c \
